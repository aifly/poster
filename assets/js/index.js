	...
	window.vue = new _vue2['default']({
		...
		mounted: function mounted() {
	  	...
	  	console.log(data);
			...
			_componentsLibUtilJs2['default'].wxConfig(document.title, document.title);
		}
	});
	...
	exports['default'] = {
		...
		data: function data() {
			return {
				...
				links: ['http://h5.zhongguowangshi.com/poster/assets/vr/budala.html', 'http://h5.zhongguowangshi.com/poster/assets/vr/laolongtou.html', 'http://h5.zhongguowangshi.com/poster/assets/vr/qiandao.html', 'http://h5.zhongguowangshi.com/poster/assets/vr/sennan.html', 'http://h5.zhongguowangshi.com/poster/assets/vr/shijiezhichuang.html'],
				show: false,
				retractIndex: 0,
								...
								_jquery2['default'].ajax({
									...
									success: function success(data) {
										...
										if (data.getret === 0) {
											...
											_libUtilJs2['default'].wxConfig(document.title, document.title, url);
