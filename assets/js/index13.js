...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _componentsVrVr = __webpack_require__(15);

	var _componentsVrVr2 = _interopRequireDefault(_componentsVrVr);

	var _componentsPosterPoster = __webpack_require__(20);

	var _componentsPosterPoster2 = _interopRequireDefault(_componentsPosterPoster);

	var _componentsLibObserable = __webpack_require__(27);
	...
	window.vue = new _vue2['default']({
		...
		components: {
			...
			Vr: _componentsVrVr2['default'],
			Poster: _componentsPosterPoster2['default']
		},
		mounted: function mounted() {
			var _this = this;

			var username = _componentsLibUtilJs2['default'].getQueryString('username'),
			    wish = _componentsLibUtilJs2['default'].getQueryString('wish'),
			...
			if (this.isShare) {
				...
				setTimeout(function () {
					...
					url = _componentsLibUtilJs2['default'].changeURLPar(url, 'username', encodeURI(username));
					url = _componentsLibUtilJs2['default'].changeURLPar(url, 'wish', encodeURI(wish));
					url = _componentsLibUtilJs2['default'].changeURLPar(url, 'src', src);

					_componentsLibUtilJs2['default'].wxConfig(document.title, document.title, url);
				}, 10);
			} else {}
...
/***/ (function(module, exports, __webpack_require__) {
	...
	if (false) {(function () {  module.hot.accept()
	  ...
	  var id = "F:\\xuchang2018\\project\\poster\\components\\index\\index.vue"
	  if (!module.hot.data) {
...
/***/ (function(module, exports, __webpack_require__) {
	...
	if (false) {(function () {  module.hot.accept()
	  ...
	  hotAPI.install(require("vue"), true)
	  if (!hotAPI.compatible) return
	  var id = "F:\\xuchang2018\\project\\poster\\components\\vr\\vr.vue"
	  if (!module.hot.data) {
	    hotAPI.createRecord(id, module.exports)
	  } else {
	    hotAPI.update(id, module.exports, __vue_template__)
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _libUtilJs = __webpack_require__(12);
	...
	exports['default'] = {
		...
		data: function data() {
			return {
				...
				links: ['http://h5.zhongguowangshi.com/' + window.h5name + '/assets/vr/waitan.html', 'http://h5.zhongguowangshi.com/' + window.h5name + '/assets/vr/shijiezhichuang.html', 'http://h5.zhongguowangshi.com/' + window.h5name + '/assets/vr/yangzhuoyongcuo.html', 'http://h5.zhongguowangshi.com/' + window.h5name + '/assets/vr/beiji.html', 'http://h5.zhongguowangshi.com/' + window.h5name + '/assets/vr/tiananmen.html'],
				show: false,
				retractIndex: 0,
				...
				wishWords: '',
				placeholderIndex: 0,
				placeholders: ['腰带渐短终难弃，每逢佳节胖三斤', '洛阳亲友如相问，还行可以正在谈', '一年将尽夜，万里未归人', '万物迎春送残腊，一年结局在今宵', '明年岂无年，心事恐蹉跎', '人生如逆旅，我亦是行人', '时人不识凌云木，直待凌云始道高', '等闲识得东风面，万紫千红总是春', '数人世相逢，百年欢笑，能得几回又', '山有木兮木有枝，心悦君兮君不知', '新年新颜新时代，中意中坚中国梦', '耕种岁月，勿负芳华', '又老一岁，你在哪里？', '花不盛开，因你未来', '心安处即吾乡，你不在心怎安', '再不ＧＯ　ＵＰ，就要狗带', '心有凌云志，身有百神通，也得过个年', '近乡情可怯，仍是未嫁人 '],
				viewH: document.documentElement.clientHeight,
		...
		methods: {
			...
			usernameForcus: function usernameForcus(e, type) {
				var _this = this;

				e.preventDefault();
				if (_libUtilJs2['default'].isAndroid()) {
					setTimeout(function () {
						var endH = document.documentElement.clientHeight;
						_this.transY = (endH - _this.viewH) / 2;
					}, 200);
				} else {

					setTimeout(function () {
						_this.$refs[type].scrollIntoView(true);
					}, 500);
					//this.pageTransY = -120;
				}
				return false;
			},
			usernameBlur: function usernameBlur(e) {
				e.preventDefault();
				this.transY = 0;
				this.pageTransY = 0;
				return false;
			},
			openVr: function openVr(index) {
			...
			toggleVrNav: function toggleVrNav() {
				var _this2 = this;
				...
				if (this.navState === 'open') {
					...
					var t = setInterval(function () {
						if (_this2.retractIndex >= 5) {
							_this2.retractIndex = 5;
							clearInterval(t);
						} else {
							_this2.retractIndex++;
						}
						console.log(_this2.retractIndex, _this2.retractIndex * 1.4);
					}, 100);
				} else {
					this.navState = 'open';
					var t = setInterval(function () {
						if (_this2.retractIndex <= 0) {
							_this2.retractIndex = 0;
							clearInterval(t);
						} else {
							_this2.retractIndex--;
						}
...
/***/ (function(module, exports, __webpack_require__) {
	...
	if(false) {
		// When the styles change, update the <style> tags
		if(!content.locals) {
			module.hot.accept("!!../../node_modules/css-loader/index.js!./vr.css", function() {
				var newContent = require("!!../../node_modules/css-loader/index.js!./vr.css");
				if(typeof newContent === 'string') newContent = [[module.id, newContent, '']];
				update(newContent);
			});
		}
...
/***/ (function(module, exports, __webpack_require__) {
	...
	// module
	exports.push([module.id, "/*.ant-btn:focus, .ant-btn:hover,.ant-input:focus, .ant-input:hover {\r\n    background-color: #fff;\r\n    border-color: #bf1616;\r\n    box-shadow: 0 0 0 2px rgba(191, 22, 22, 0.1);\r\n}*/\r\n.lt-full {\r\n  width: 100%;\r\n  height: 100%;\r\n  position: absolute;\r\n  left: 0;\r\n  top: 0; }\r\n\r\n.zmiti-text-overflow {\r\n  overflow: hidden;\r\n  white-space: nowrap;\r\n  word-break: break-all;\r\n  text-overflow: ellipsis;\r\n  -webkit-text-overflow: ellipsis; }\r\n\r\n.zmiti-play {\r\n  width: .8rem;\r\n  height: .8rem;\r\n  border-radius: 50%;\r\n  position: fixed;\r\n  z-index: 1000;\r\n  right: .5rem;\r\n  top: .5rem; }\r\n  .zmiti-play.rotate {\r\n    -webkit-animation: rotate 5s linear infinite;\r\n    animation: rotate 5s linear infinite; }\r\n\r\n@-webkit-keyframes rotate {\r\n  to {\r\n    -webkit-transform: rotate(360deg);\r\n    transform: rotate(360deg); } }\r\n.zmiti-vr-main-ui {\r\n  z-index: 10;\r\n  background: #fff;\r\n  overflow: hidden;\r\n  position: fixed; }\r\n  .zmiti-vr-main-ui .zmiti-vr-bottom {\r\n    width: 10rem;\r\n    position: absolute;\r\n    left: 0;\r\n    z-index: 1; }\r\n  .zmiti-vr-main-ui > iframe {\r\n    position: absolute;\r\n    z-index: 0;\r\n    width: 100%;\r\n    height: 100%; }\r\n  .zmiti-vr-main-ui .zmiti-vr-nav {\r\n    position: absolute;\r\n    z-index: 2;\r\n    width: 3rem;\r\n    left: 0;\r\n    top: 0; }\r\n    .zmiti-vr-main-ui .zmiti-vr-nav ul {\r\n      width: 1.5rem;\r\n      position: relative;\r\n      left: .75rem;\r\n      top: -.5rem; }\r\n      .zmiti-vr-main-ui .zmiti-vr-nav ul li {\r\n        position: relative;\r\n        height: 1.4rem;\r\n        overflow: hidden;\r\n        -webkit-transition: 0.5s;\r\n        transition: 0.5s; }\r\n        .zmiti-vr-main-ui .zmiti-vr-nav ul li img {\r\n          position: absolute;\r\n          left: 0;\r\n          top: 0; }\r\n        .zmiti-vr-main-ui .zmiti-vr-nav ul li:last-of-type {\r\n          position: absolute;\r\n          width: 100%;\r\n          top: 0;\r\n          left: 0;\r\n          -webkit-transform: translateY(7rem);\r\n          transform: translateY(7rem); }\r\n      .zmiti-vr-main-ui .zmiti-vr-nav ul .zmiti-nav-enter, .zmiti-vr-main-ui .zmiti-vr-nav ul .zmiti-nav-leave-to {\r\n        opacity: 0; }\r\n  .zmiti-vr-main-ui .zmiti-vr-dog {\r\n    width: 4rem;\r\n    position: absolute;\r\n    left: 2rem;\r\n    z-index: 1; }\r\n  .zmiti-vr-main-ui .zmiti-poster-info {\r\n    z-index: 10;\r\n    background: rgba(0, 0, 0, 0.5); }\r\n    .zmiti-vr-main-ui .zmiti-poster-info .zmiti-poster-info-C {\r\n      width: 8rem;\r\n      position: absolute;\r\n      display: -webkit-box;\r\n      -webkit-box-align: center;\r\n      -webkit-box-pack: center;\r\n      -webkit-box-orient: horizontal;\r\n      left: 1rem;\r\n      height: 100%; }\r\n      .zmiti-vr-main-ui .zmiti-poster-info .zmiti-poster-info-C .zmiti-poster-dog, .zmiti-vr-main-ui .zmiti-poster-info .zmiti-poster-info-C .zmiti-poster-yearofdog {\r\n        width: 50%;\r\n        position: absolute;\r\n        left: 25%; }\r\n      .zmiti-vr-main-ui .zmiti-poster-info .zmiti-poster-info-C .zmiti-poster-dog {\r\n        top: -3rem;\r\n        z-index: -1; }\r\n      .zmiti-vr-main-ui .zmiti-poster-info .zmiti-poster-info-C .zmiti-poster-yearofdog {\r\n        top: -.2rem;\r\n        z-index: 2; }\r\n      .zmiti-vr-main-ui .zmiti-poster-info .zmiti-poster-info-C .zmiti-wish-C {\r\n        top: .5rem;\r\n        position: relative;\r\n        left: 0;\r\n        z-index: 1;\r\n        width: 100%; }\r\n        .zmiti-vr-main-ui .zmiti-poster-info .zmiti-poster-info-C .zmiti-wish-C > img {\r\n          bottom: 0;\r\n          left: 0; }\r\n      .zmiti-vr-main-ui .zmiti-poster-info .zmiti-poster-info-C .zmiti-poster-form {\r\n        position: absolute;\r\n        top: .8rem;\r\n        width: 80%;\r\n        left: 10%;\r\n        text-align: center; }\r\n        .zmiti-vr-main-ui .zmiti-poster-info .zmiti-poster-info-C .zmiti-poster-form > h2 {\r\n          height: 1.8rem;\r\n          line-height: 2.2rem; }\r\n        .zmiti-vr-main-ui .zmiti-poster-info .zmiti-poster-info-C .zmiti-poster-form .zmiti-form-item {\r\n          text-align: left;\r\n          font-size: .5rem;\r\n          height: .8rem;\r\n          position: relative; }\r\n        .zmiti-vr-main-ui .zmiti-poster-info .zmiti-poster-info-C .zmiti-poster-form .zmiti-form-item1 {\r\n          text-align: left;\r\n          font-size: .5rem;\r\n          height: 1rem;\r\n          position: relative; }\r\n          .zmiti-vr-main-ui .zmiti-poster-info .zmiti-poster-info-C .zmiti-poster-form .zmiti-form-item1 input {\r\n            width: 100%;\r\n            border: 1px solid #a80318;\r\n            height: .8rem;\r\n            padding: .2rem;\r\n            box-sizing: border-box;\r\n            margin-top: -.2rem;\r\n            border-radius: 0.1rem;\r\n            outline: none;\r\n            font-size: .4rem; }\r\n        .zmiti-vr-main-ui .zmiti-poster-info .zmiti-poster-info-C .zmiti-poster-form .zmiti-form-item2 {\r\n          height: 2rem; }\r\n          .zmiti-vr-main-ui .zmiti-poster-info .zmiti-poster-info-C .zmiti-poster-form .zmiti-form-item2 textarea {\r\n            font-size: .4rem;\r\n            border: 1px solid #a80318;\r\n            border-radius: 0.1rem;\r\n            box-sizing: border-box;\r\n            padding: .2rem;\r\n            position: absolute;\r\n            width: 100%;\r\n            height: 100%;\r\n            resize: none;\r\n            outline: none; }\r\n          .zmiti-vr-main-ui .zmiti-poster-info .zmiti-poster-info-C .zmiti-poster-form .zmiti-form-item2 .zmiti-change {\r\n            position: absolute;\r\n            right: .1rem;\r\n            bottom: .1rem;\r\n            z-index: 10;\r\n            font-size: .36rem;\r\n            color: #fb0000; }\r\n        .zmiti-vr-main-ui .zmiti-poster-info .zmiti-poster-info-C .zmiti-poster-form .zmiti-create-poster-btn {\r\n          background: #a80318;\r\n          color: #fff;\r\n          height: 1rem;\r\n          text-align: center;\r\n          line-height: 1rem;\r\n          margin: .5rem auto;\r\n          border-radius: 0.2rem; }\r\n          .zmiti-vr-main-ui .zmiti-poster-info .zmiti-poster-info-C .zmiti-poster-form .zmiti-create-poster-btn.disabled {\r\n            background: #ccc;\r\n            color: #bbb; }\r\n  .zmiti-vr-main-ui .zmiti-tip {\r\n    position: absolute;\r\n    z-index: 100;\r\n    left: 0;\r\n    top: 0;\r\n    width: 100%;\r\n    height: 100%;\r\n    background: rgba(0, 0, 0, 0.3); }\r\n    .zmiti-vr-main-ui .zmiti-tip img {\r\n      display: block;\r\n      width: 7rem;\r\n      position: absolute;\r\n      left: 50%;\r\n      top: 50%;\r\n      -webkit-transform: translate(-50%, -50%);\r\n      transform: translate(-50%, -50%); }\r\n\r\n/*# sourceMappingURL=vr.css.map */\r\n", ""]);
...
/***/ (function(module, exports, __webpack_require__) {
	...
	if (false) {(function () {  module.hot.accept()
	  ...
	  hotAPI.install(require("vue"), true)
	  if (!hotAPI.compatible) return
	  var id = "F:\\xuchang2018\\project\\poster\\components\\poster\\poster.vue"
	  if (!module.hot.data) {
	    hotAPI.createRecord(id, module.exports)
	  } else {
	    hotAPI.update(id, module.exports, __vue_template__)
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _libAssets = __webpack_require__(11);

	var _libAssets2 = _interopRequireDefault(_libAssets);

	var _libData = __webpack_require__(24);
	...
	exports['default'] = {
		...
		mounted: function mounted() {
			...
			obserable.on('getWish', function (data) {

				_this2.username = data.username;
				_this2.wish = data.wish;
				var s = _this2;
				...
				if (!data.src) {
					...
					setTimeout(function () {
						...
						var dom = _this2.$refs['share-page'];
						var dpi = 2;
						html2canvas(dom, {
							useCORS: true,
	           	...
	           	success(data){
	           		console.log(data);
											...
											var url = window.location.href.split('#')[0];
											url = _libUtilJs2['default'].changeURLPar(url, 'username', encodeURI(username));
											url = _libUtilJs2['default'].changeURLPar(url, 'wish', encodeURI(wish));
											url = _libUtilJs2['default'].changeURLPar(url, 'src', src);

											_libUtilJs2['default'].wxConfig(document.title, window.desc, url);
			...
			obserable.on('showPoster', function () {
				_this2.show = true;
			});
		}
	};
...
/***/ (function(module, exports, __webpack_require__) {
	...
	// module
	exports.push([module.id, "@charset \"UTF-8\";\r\n/*.ant-btn:focus, .ant-btn:hover,.ant-input:focus, .ant-input:hover {\r\n    background-color: #fff;\r\n    border-color: #bf1616;\r\n    box-shadow: 0 0 0 2px rgba(191, 22, 22, 0.1);\r\n}*/\r\n.lt-full {\r\n  width: 100%;\r\n  height: 100%;\r\n  position: absolute;\r\n  left: 0;\r\n  top: 0; }\r\n\r\n.zmiti-text-overflow {\r\n  overflow: hidden;\r\n  white-space: nowrap;\r\n  word-break: break-all;\r\n  text-overflow: ellipsis;\r\n  -webkit-text-overflow: ellipsis; }\r\n\r\n.zmiti-play {\r\n  width: .8rem;\r\n  height: .8rem;\r\n  border-radius: 50%;\r\n  position: fixed;\r\n  z-index: 1000;\r\n  right: .5rem;\r\n  top: .5rem; }\r\n  .zmiti-play.rotate {\r\n    -webkit-animation: rotate 5s linear infinite;\r\n    animation: rotate 5s linear infinite; }\r\n\r\n@-webkit-keyframes rotate {\r\n  to {\r\n    -webkit-transform: rotate(360deg);\r\n    transform: rotate(360deg); } }\r\n.zmiti-poster-main-ui {\r\n  z-index: -1;\r\n  opacity: 0;\r\n  -webkit-transition: 0.5s;\r\n  transition: 0.5s; }\r\n  .zmiti-poster-main-ui.show {\r\n    opacity: 1;\r\n    z-index: 20; }\r\n  .zmiti-poster-main-ui .zmiti-logo {\r\n    position: absolute;\r\n    width: 2.5rem;\r\n    left: .5rem;\r\n    top: .3rem;\r\n    z-index: 10;\r\n    font-size: 12px; }\r\n    .zmiti-poster-main-ui .zmiti-logo img {\r\n      width: 1.2rem; }\r\n  .zmiti-poster-main-ui .zmiti-share-page1 {\r\n    position: absolute;\r\n    z-index: -1000;\r\n    left: 20rem;\r\n    top: 20rem;\r\n    -webkit-transform: scale(2);\r\n    transform: scale(2);\r\n    width: 100%;\r\n    height: 101%;\r\n    overflow: hidden; }\r\n  .zmiti-poster-main-ui .zmiti-home {\r\n    width: 5rem;\r\n    position: absolute;\r\n    left: 2.5rem;\r\n    background: rgba(0, 0, 0, 0.5);\r\n    padding: .2rem .3rem .8rem .3rem;\r\n    box-sizing: border-box;\r\n    border-radius: 10px; }\r\n  .zmiti-poster-main-ui .zmiti-clip-img {\r\n    position: absolute;\r\n    z-index: 10;\r\n    width: 100%;\r\n    height: 100%; }\r\n    .zmiti-poster-main-ui .zmiti-clip-img .share-enter-active, .zmiti-poster-main-ui .zmiti-clip-img .share-leave-active {\r\n      -webkit-transform: scale(0.8);\r\n      transform: scale(0.8); }\r\n    .zmiti-poster-main-ui .zmiti-clip-img .share-enter, .zmiti-poster-main-ui .zmiti-clip-img .share-leave-to {\r\n      opacity: 0;\r\n      -webkit-transform: scale(1);\r\n      transform: scale(1); }\r\n    .zmiti-poster-main-ui .zmiti-clip-img.active:after {\r\n      content: \"\\957F\\6309\\4FDD\\5B58\\56FE\\7247\";\r\n      position: absolute;\r\n      width: .38rem;\r\n      z-index: 10;\r\n      right: .55rem;\r\n      font-size: 12px;\r\n      color: #fff;\r\n      bottom: 14vh; }\r\n    .zmiti-poster-main-ui .zmiti-clip-img > div {\r\n      overflow: hidden;\r\n      border: 2px solid #fff;\r\n      -webkit-transition: 0.4s;\r\n      transition: 0.4s;\r\n      -webkit-transform: scale(0.8);\r\n      transform: scale(0.8);\r\n      -webkit-transform-origin: center 30%;\r\n      transform-origin: center 30%;\r\n      width: 100%;\r\n      height: 100%;\r\n      box-sizing: border-box; }\r\n    .zmiti-poster-main-ui .zmiti-clip-img:before {\r\n      content: '';\r\n      position: absolute;\r\n      left: 0;\r\n      top: 0;\r\n      width: 100%;\r\n      height: 100%;\r\n      box-shadow: 0 0 6px #853c24; }\r\n  .zmiti-poster-main-ui .zmiti-qrcode {\r\n    width: 2rem;\r\n    position: absolute;\r\n    z-index: 1;\r\n    padding: 3px; }\r\n  .zmiti-poster-main-ui .zmiti-wish {\r\n    color: #fff; }\r\n    .zmiti-poster-main-ui .zmiti-wish span {\r\n      position: absolute;\r\n      width: .6rem;\r\n      top: 2rem;\r\n      left: 1.1rem;\r\n      font-size: 12px;\r\n      height: 80%;\r\n      top: 0;\r\n      display: -webkit-box;\r\n      -webkit-box-align: center;\r\n      -webkit-box-pack: center;\r\n      -webkit-box-orient: horizontal; }\r\n      .zmiti-poster-main-ui .zmiti-wish span label {\r\n        display: block; }\r\n      .zmiti-poster-main-ui .zmiti-wish span:nth-of-type(2) {\r\n        left: 1.7rem; }\r\n  .zmiti-poster-main-ui .zmiti-poster1 {\r\n    position: absolute;\r\n    width: 6rem;\r\n    left: 2rem;\r\n    top: 3.5rem; }\r\n    .zmiti-poster-main-ui .zmiti-poster1 .zmiti-wish {\r\n      color: #813c1f;\r\n      position: relative;\r\n      text-align: center;\r\n      line-height: .8rem; }\r\n    .zmiti-poster-main-ui .zmiti-poster1 .zmiti-username {\r\n      color: #813c1f;\r\n      position: relative;\r\n      text-align: center;\r\n      height: 1rem;\r\n      left: 0;\r\n      font-size: .55rem;\r\n      top: .1rem; }\r\n  .zmiti-poster-main-ui .zmiti-poster2 {\r\n    position: absolute;\r\n    width: 6rem;\r\n    left: 2rem;\r\n    bottom: 1rem; }\r\n    .zmiti-poster-main-ui .zmiti-poster2 .zmiti-wish {\r\n      color: #fff;\r\n      position: relative;\r\n      line-height: .8rem;\r\n      text-align: center; }\r\n    .zmiti-poster-main-ui .zmiti-poster2 .zmiti-username {\r\n      color: #fff;\r\n      position: relative;\r\n      text-align: center;\r\n      height: 1rem;\r\n      left: 0;\r\n      top: .1rem; }\r\n    .zmiti-poster-main-ui .zmiti-poster2 > div {\r\n      text-align: center;\r\n      color: #fff; }\r\n  .zmiti-poster-main-ui .zmiti-poster3 {\r\n    position: absolute;\r\n    width: 6rem;\r\n    left: 2rem;\r\n    top: 6rem; }\r\n    .zmiti-poster-main-ui .zmiti-poster3 .zmiti-wish {\r\n      color: #000;\r\n      position: relative;\r\n      text-align: center;\r\n      line-height: .8rem; }\r\n    .zmiti-poster-main-ui .zmiti-poster3 .zmiti-username {\r\n      color: #000;\r\n      position: relative;\r\n      text-align: center;\r\n      height: 1rem;\r\n      left: 0;\r\n      top: .1rem; }\r\n  .zmiti-poster-main-ui .zmiti-username {\r\n    color: #fff;\r\n    font-size: .55rem;\r\n    position: absolute;\r\n    left: .6rem;\r\n    top: 4rem; }\r\n    .zmiti-poster-main-ui .zmiti-username span {\r\n      display: block;\r\n      -webkit-transform: rotate(90deg);\r\n      transform: rotate(90deg); }\r\n  .zmiti-poster-main-ui .zmiti-poster-btns {\r\n    position: absolute;\r\n    bottom: 1rem;\r\n    left: 0;\r\n    z-index: 10;\r\n    width: 6rem;\r\n    left: 2rem;\r\n    display: -webkit-box;\r\n    -webkit-box-align: center;\r\n    -webkit-box-pack: center;\r\n    -webkit-box-orient: horizontal;\r\n    -webkit-box-pack: justify; }\r\n    .zmiti-poster-main-ui .zmiti-poster-btns > div {\r\n      background: #f4b470;\r\n      color: #6a4824;\r\n      width: 2.6rem;\r\n      text-align: center;\r\n      height: .8rem;\r\n      line-height: .8rem;\r\n      border-radius: 4px; }\r\n      .zmiti-poster-main-ui .zmiti-poster-btns > div:nth-of-type(1) {\r\n        margin-right: .5rem; }\r\n  .zmiti-poster-main-ui .zmiti-do-poster {\r\n    position: absolute;\r\n    width: 2rem;\r\n    height: .8rem;\r\n    line-height: .8rem;\r\n    text-align: center;\r\n    color: #fff;\r\n    right: .5rem;\r\n    top: .5rem;\r\n    background: rgba(0, 0, 0, 0.5);\r\n    padding: 0 .2rem;\r\n    border-radius: 0.1rem; }\r\n    .zmiti-poster-main-ui .zmiti-do-poster a {\r\n      color: inherit;\r\n      display: block;\r\n      width: 100%;\r\n      height: 100%; }\r\n    .zmiti-poster-main-ui .zmiti-do-poster.zmiti-do-poster1 {\r\n      background: rgba(255, 255, 255, 0.7);\r\n      color: #000; }\r\n\r\n/*# sourceMappingURL=poster.css.map */\r\n", ""]);
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var posterList = [{
		pageStyle: {
			background: 'url(' + _assetsJs2['default'].poster1 + ') no-repeat center bottom',
		...
		pageStyle: {
			background: 'url(' + _assetsJs2['default'].poster2 + ') no-repeat center bottom',
			backgroundSize: 'cover'
		},
		doPosterClass: '', //zmiti-do-poster1
		logoColor: "#853c24",
		...
		pageStyle: {
			background: 'url(' + _assetsJs2['default'].poster3 + ') no-repeat center bottom',
			backgroundSize: 'cover'
		},
		doPosterClass: '', //zmiti-do-poster1
		logoColor: "#fff",
		...
		pageStyle: {
			background: 'url(' + _assetsJs2['default'].poster4 + ') no-repeat center top',
			backgroundSize: 'cover'
		},
		doPosterClass: 'zmiti-do-poster1', //
		logoColor: "#000",
